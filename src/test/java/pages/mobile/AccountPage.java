...
public class AccountPage {
    ...
    private final SelenideElement
            startMeetingButton = $(id("ru.webinar.mobile:id/error_action_button")),
            toolBarStings = $(id("ru.webinar.mobile:id/settings")),
    ...
    public AccountPage checkStartMeetingButtonVisible() {
        startMeetingButton.shouldBe(visible);
        return this;
    }

    @Step("Нажать на вкладку Настройки")
    public AccountPage clickToolBarStings() {
        toolBarStings.click();
        return this;
    }
